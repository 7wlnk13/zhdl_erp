    ...
    data () {
      return {
        ...
        columns: [
          ...
          {
            title: '采购价', dataIndex: 'purchaseDecimal', width: 70, customRender: function (text, record, index) {
              if(record.otherField1=="yes"){
                // var property = "";
                // for (var item in record) {
                //     property += "属性：" + item + "数值：" + record[item] + "\n";
                // }
                // console.log('temp:' + property);
                return 0;
              }else{
                return record.purchaseDecimal;
              }
            }
          },
